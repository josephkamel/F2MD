...
plot "AppV2.dat" using (funcT($2)):(ACC($6,($5-$4),($7-$6),$4)) title "V2 Accuracy" with linespoints linestyle 2 lw 2 pi 30 ps 0.75 lc rgb "blue",\
"AppV1.dat" using (funcT($2)):(ACC($6,($5-$4),($7-$6),$4)) title "V1 Accuracy" with lines lw 2 lc rgb "red"
