...
public:
    ...
    double calculateInsersion(const Coord& pos, double deltaX, double deltaY);
    double calculateInsersionList(const Coord& pos, double deltaX,
            double deltaY, Coord pList[], int pListSize);
