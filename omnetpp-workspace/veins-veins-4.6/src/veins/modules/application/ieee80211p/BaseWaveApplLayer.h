...
#include "../misbehaviorDetection/supportClasses/GaussianRandom.h"
#include "../misbehaviorDetection/supportClasses/MDMLib.h"
...
protected:
    ...
    virtual void populateWSM(WaveShortMessage* wsm, int rcvId = 0, int serial =
            0);
     ...
     */
    virtual void startService(Channels::ChannelNumber channel, int serviceId,
