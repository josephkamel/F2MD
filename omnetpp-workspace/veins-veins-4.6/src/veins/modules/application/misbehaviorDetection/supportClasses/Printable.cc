...
void Printable::incAll(mbTypes::Mbs mbType) {
    switch (mbType) {
...
void Printable::incCumulFlags(mbTypes::Mbs mbType) {
...
void Printable::incFlags(mdChecksTypes::Checks check, mbTypes::Mbs mbType) {
